...
#from biapy.portlets.sociallinks import SocialLinksPortletMessageFactory as _
...
class Assignment(base.Assignment):
    ...
    implements(ISocialLinksPortlet)
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('sociallinksportlet.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(ISocialLinksPortlet)
